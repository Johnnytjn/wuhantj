    ...
    initGraph2(newData) {
      ...
      while (i-- > 0) {
        Object.entries(newData["tags"]).forEach(([name, value]) => {
          wordList.push([name + i, value * 100]);
        });
      }
      console.log(">>>>>wordcloud:", WordCloud.isSupported);
      const wcCanvas = document.getElementById("tag-wordcloud");
      WordCloud(wcCanvas, {
        list: wordList,
        gridSize: 4,
        weightFactor: 1,
